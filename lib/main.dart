...
import 'package:flutter_dib/SplashScreen.dart';
...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      routes: {
        StartScreen.id: (c) => StartScreen(),
        MobileLoginScreen.id: (c) => MobileLoginScreen(),
        EmailLoginScreen.id: (c) => EmailLoginScreen(),
        MyAccount.id: (c) => MyAccount(),
        RegistrationOptionalScreen.id: (c) => RegistrationOptionalScreen(),
